...
namespace graphicEditor
{
    ...
    //также можно вынести код в отдельный файл, починить сохранение,
    //починить sleep, сделать реализацию сплошного (заливки) рисования фигур, 


    //сделал треугольник, сделал нормальную рисовку во все стороны, enum, 
